...
fit2 <- ppm(eagles_ppp ~ bs(Elevation, df=8) + bs(Forest, df= 10) + HFI + I(HFI^2), data = DATA, use.gam = TRUE)
...
# Testing  Model Complexity
fit3 <- ppm(eagles_ppp ~ bs(Elevation, df=8) + bs(Forest, df= 10) + HFI + I(HFI^2) + Dist_Water, data = DATA, use.gam = TRUE)
